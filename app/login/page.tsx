    ...
    <div className="nx-bg min-h-screen flex items-center justify-center px-4 py-10">
      <div className="nx-glass nx-fade w-full max-w-sm rounded-3xl p-8 shadow-[0_24px_80px_rgba(0,0,0,.6)]">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1.5">Study together, with an AI tutor.</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          No account?{" "}
          <a href="/signup" className="font-semibold text-purple-300 underline-offset-2 hover:text-white hover:underline">
            Sign up
          </a>
        </p>
      </div>
