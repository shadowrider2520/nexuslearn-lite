...
export async function POST(req: Request) {
  ...
  console.log("=================================");
  console.log("CHAT API START:", requestId);
  console.log("=================================");
  ...
  console.log("USER MESSAGE INSERT:", {
    requestId,
  ...
  // Get recent messages
  const { data: recentMsgs, error: messagesError } = await supabase
    .from("messages")
  ...
  // Call Groq
  console.log("CALLING GROQ:", requestId);
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          },
          {
            role: "user",
            content:
              recentMsgs?.[recentMsgs.length - 1]?.content ??
              content,
          },
        ],
        temperature: 0.6,
  ...
  // Save AI response
  console.log("ABOUT TO INSERT AI:", requestId);
  ...
  console.log("=================================");
  console.log("CHAT API END:", requestId);
  console.log("=================================");
